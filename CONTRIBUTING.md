# Contributing to Domain Availability Check
...
Please make sure your code follows the project's coding style and all tests pass.
...
-   We use [Prettier](https://prettier.io/) for code formatting. Please run `yarn lint` before committing your changes.
